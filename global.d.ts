...
import {Modelsservice} from './api/services/ModelsService'
...
declare global {
    ...
    interface Response extends express.Response {
        ...
        /**
         * only in soap controllers
         */
        respond(object: dynamicObjects, fullOperationName: string, additionalHeaders?: dynamicObjects): any;
